...
// File: matrix_server/config/enter.go
...
type MQ struct {
	...
	BatchUpdateDeployExchangeName string `yaml:"batchUpdateDeployExchangeName"` // 批量更新部署交换机名称
	...
	WsTopic                       string `yaml:"wsTopic"`                       // websocket上报状态的topic
}
